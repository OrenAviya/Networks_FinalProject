...
def process_packet(packet):
    ...
    #     # Extract the source IP, destination IP, timestamp, and size
    #     src_ip = packet[0].getlayer(IP).src
    #     dst_ip = packet[0].getlayer(IP).dst
    #     timestamp = time.time()
    #     size = len(packet)
...
try:
    ...
    sniff(filter="tcp port 443 or tcp port 80 ", prn=process_packet, timeout=60)

    # Process and plot the data for each message group
    for group_identifier, messages in message_groups.items():
        if group_identifier == "2a02:6680:2105:aa78:5d79:df94:5095:14ea_2a03:2880:f242:1c2:face:b00c:0:167" or group_identifier=="2a03:2880:f242:1c2:face:b00c:0:167_2a02:6680:2105:aa78:5d79:df94:5095:14ea":
